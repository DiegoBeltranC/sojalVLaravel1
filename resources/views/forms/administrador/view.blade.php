<!-- resources/views/forms/administrador/view.blade.php -->
    ...
    <div class="modal-content">
        ...
        <div id="workerInfo">
            ...
            <div class="form-group">
                ...
                <img id="profilePictureView" src="{{ asset('images/default_profile.png') }}" alt="Foto de Perfil" style="max-width: 150px;">
            </div>
            <div class="form-group">
                <label>Nombre:</label>
