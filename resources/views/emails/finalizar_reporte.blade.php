...
<body>
    <div class="email-container">
        ...
        <div class="header">Reporte Finalizado</div>
        <div class="content">
            <p>{{ $user->nombre }}</p>
            <p>El reporte con <strong>ID: {{ $reporte->id }}</strong> ha sido finalizado</p>
            <p class="motivo"><strong>Su reporte ha sido finalizado exitosamente</strong></p>
        </div>
        <div class="footer">
